...
namespace BlazorServer.CompositePatternExample.Shared
{
    public static class Splats
    {
        ...
        public static Dictionary<string, object> IconButton(string label, Color color, string icon)
        {
            Dictionary<string, object> attributes = new ()
            {
                { "id", $"iconbutton_{GenerateId(label)}" },
                { "Variant",Variant.Filled },
                { "Color", color },
                { "StartIcon", icon },
            };
